...
var _providers = _interopRequireDefault(require("../../../../modules/providers/infra/http/routes/providers.routes"));
...
var _availability = _interopRequireDefault(require("../../../../modules/appointments/infra/http/routes/availability.routes"));
...
routes.use('/userprofile', _profile.default);
routes.use('/password', _password.default);
routes.use('/providers', _providers.default);
routes.use('/providers', _providers.default);
routes.use('/availability', _availability.default);
routes.use('/sessions', [_sessions.default, _sessions2.default]);
var _default = routes;
